...
public interface RoomSetDao {
    ...
    // 模糊查询
    /*
     * public List<RoomSetPo> fuzzyselectPo(@Param("roomNumber")String
     * roomNumber);
     */

    // 分页模糊查询
    public List<RoomSetPo> pageFuzzyselect(@Param("roomNumber") String roomNumber, @Param("start") int start,
