...
public class Predetermine {
    ...
    // 修改房间，移除房间时更改房态
    /*
     * @RequestMapping("/changRoomState") public ModelAndView changRoomState(){
     * ModelAndView mv=null;
     * 
     * return mv; }
     */
    ...
    public ModelAndView arrangeRoom(String id, Integer tiaoZhuang) {
        ...
        for (int i = 0; i < FenGe.length; i++) {
            ...
            stayRegisterPo.setSumConst(
                    roomSetPo.getStandardPriceDay() * Integer.parseInt(predeterminePo.getPredetermineDay())); // 获取房价
                                                                                                              // 乘以
                                                                                                              // 住宿天数
            ...
            roomSetPoToRoomState.setId(predeterminePo.getRoomID()); // 给新的 Po
                                                                    // 赋房间ID的值
