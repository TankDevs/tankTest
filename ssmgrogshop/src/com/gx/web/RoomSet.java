...
public class RoomSet {
    ...
    /*
     * @RequestMapping("/tolist") public ModelAndView tolist(){ ModelAndView
     * mv=null; List<RoomSetPo> list=roomSetService.selectAll(); mv=new
     * ModelAndView("/roomset/roomset"); mv.addObject("list",list); return mv; }
     */
